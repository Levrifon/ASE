...
void write_bloc(unsigned int vol, unsigned nbloc, unsigned char * buffer);
void write_blocn(unsigned int vol, unsigned nbloc, unsigned char * buffer, unsigned int size);
